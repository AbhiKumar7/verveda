    ...
    <div className="min-h-screen bg-ivory pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <nav className="flex items-center text-sm mb-8 font-sans">
          ...
          <span className="mx-2 text-charcoal/30">/</span>
          <span className="text-gold-400 font-medium">Hoop Earrings</span>
        </nav>

        {/* Page Header with Image */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16 items-center">
          <div>
            <span className="text-xs uppercase tracking-[0.3em] text-gold-400 font-semibold">Statement Style</span>
            <h1 className="font-serif text-5xl md:text-6xl text-charcoal mt-3 mb-4">
              Hoop Earrings
            </h1>
            <div className="w-16 h-px bg-gold-300"></div>
            <p className="text-charcoal/60 mt-6 font-sans text-lg leading-relaxed">
              From classic everyday hoops to statement diamond-studded designs, 
              our collection offers the perfect hoop for every style and occasion.
            </p>
            <div className="flex flex-wrap gap-4 mt-8">
              <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-sm shadow-sm">
                <span className="text-gold-400 font-serif text-2xl">✦</span>
                <div>
                  <p className="text-xs uppercase tracking-wider text-charcoal/40 font-sans">Size Range</p>
                  <p className="text-sm font-semibold text-charcoal font-sans">12mm - 25mm</p>
                </div>
              </div>
              <div className="flex items-center gap-3 bg-white px-4 py-2 rounded-sm shadow-sm">
                <span className="text-gold-400 font-serif text-2xl">✦</span>
                <div>
                  <p className="text-xs uppercase tracking-wider text-charcoal/40 font-sans">Metal Options</p>
                  <p className="text-sm font-semibold text-charcoal font-sans">Gold, Silver, Platinum</p>
                </div>
              </div>
            </div>
          </div>
          <div className="bg-sage-100 rounded-sm overflow-hidden aspect-square">
            <img 
              src="https://images.unsplash.com/photo-1605100804763-247f67b3557e?w=800&h=800&fit=crop" 
              alt="Hoop Earrings Collection"
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-10 pb-6 border-b border-sage-100">
          <div className="flex items-center gap-2 flex-wrap">
            <span className="text-sm text-charcoal/60 font-sans">Size:</span>
            ...
            >
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Link 
                    to={`/product/hoop-earring-${product.id}`}
