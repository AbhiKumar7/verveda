    ...
    <div className="min-h-screen bg-ivory pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
        ...
        <nav className="flex items-center text-sm mb-8 font-sans">
          ...
          <span className="mx-2 text-charcoal/30">/</span>
          <span className="text-gold-400 font-medium">Solitaire Earrings</span>
        </nav>

        {/* Page Header */}
        <div className="text-center mb-16">
          <span className="text-xs uppercase tracking-[0.3em] text-gold-400 font-semibold">STIMAONDS</span>
          ...
          <p className="text-charcoal/60 mt-6 max-w-2xl mx-auto font-sans text-lg leading-relaxed">
            Discover the epitome of elegance with our single-stone diamond earrings, 
            crafted to capture light and admiration from every angle.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-10 pb-6 border-b border-sage-100">
          <div className="flex items-center gap-3">
            <span className="text-sm text-charcoal/60 font-sans">Filter:</span>
            ...
            >
              ...
              <div className="p-6 space-y-3">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <Link 
                    to={`/product/solitaire-earring-${product.id}`}
...
export default SolitaireEarrings;